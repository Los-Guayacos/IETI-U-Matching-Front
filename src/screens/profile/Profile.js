          ...
          <div>
            ...
            <div className="mt-5 row">
              <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                ...
                <label className="mt-1" style={{ color: colors.secondary }}>
                  Correo electrónico
                </label>
                <input
                  className="form-control col-11"
              ...
              <div className="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                <label className="d-block" style={{ color: colors.secondary }}>
                  Edad
                </label>
                <input
                        ...
                        <div>
                          ...
                          {!uploading[key] ? (
                            <button
                              ...
                              onClick={() =>
                                document
                                  .getElementById("selectFile" + (key + 1))
                                  .click()
                              }
                            >
                              Cambiar
            ...
            <div className="mt-5">
              ...
              <label className="text-light text-center d-block mt-5">
                Decripción
              </label>
              <textarea
